...
using SistemaVenta.DAL.DBNContext;
using SistemaVenta.DAL.Interfaces;
using SistemaVenta.Entity;

namespace SistemaVenta.DAL.Implementacion
{
    public class VentaRepositoy : GenericRepository<Venta>, IVentaRepository
    {
        private readonly DBNEFSANContext _dbContext;

        public VentaRepositoy(DBNEFSANContext dbContext):base(dbContext)
        {
